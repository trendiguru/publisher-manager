...
public class ClickThruRateVisual extends Visual {

	public ClickThruRateVisual(Publisher publisher) {
		this.elasticSearchId = publisher.getEncodedName() + "-click-thru-rate";
		this.title = publisher.getName() + " Click Thru Rate";
	}
