...
public class DashboardManager extends KibanaManager {
	...
	public String jsonForDashboard(Set<Visual> visualsToAddSet) {
		...
		return "{" +
				...
				"\"description\":\"\"," +
				"\"panelsJSON\":\"[" +
					"{\\\"col\\\":1,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Click-Thru-Rate-On-Our-Icon\\\",\\\"panelIndex\\\":4,\\\"row\\\":6,\\\"size_x\\\":6,\\\"size_y\\\":3,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":7,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Click-Thru-Rate-On-Items\\\",\\\"panelIndex\\\":5,\\\"row\\\":6,\\\"size_x\\\":6,\\\"size_y\\\":3,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":1,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Top-20-Trending-Clicked-Images\\\",\\\"panelIndex\\\":6,\\\"row\\\":9,\\\"size_x\\\":6,\\\"size_y\\\":4,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":7,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Unique-Users\\\",\\\"panelIndex\\\":7,\\\"row\\\":13,\\\"size_x\\\":3,\\\"size_y\\\":2,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":10,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Average-Time-on-Site\\\",\\\"panelIndex\\\":9,\\\"row\\\":13,\\\"size_x\\\":3,\\\"size_y\\\":2,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":7,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Revenue\\\",\\\"panelIndex\\\":10,\\\"row\\\":15,\\\"size_x\\\":3,\\\"size_y\\\":2,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"col\\\":1,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Events-Breakdown\\\",\\\"panelIndex\\\":12,\\\"row\\\":1,\\\"size_x\\\":12,\\\"size_y\\\":5,\\\"type\\\":\\\"visualization\\\"}," +
					"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-World-Map\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":13,\\\"size_x\\\":6,\\\"size_y\\\":4,\\\"col\\\":1,\\\"row\\\":13}," +
					"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Devices\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":14,\\\"size_x\\\":6,\\\"size_y\\\":4,\\\"col\\\":7,\\\"row\\\":9}" +
