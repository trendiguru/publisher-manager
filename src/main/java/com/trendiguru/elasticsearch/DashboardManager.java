...
public class DashboardManager extends KibanaManager {
	...
	public String jsonForDashboard(Set<Visual> visualsToAddSet) {
		...
		//els:!((														col:1,id:XXXX-Events-Breakdown,panelIndex:1,row:5,size_x:6,size_y:5,type:visualization),
		//																(col:1,id:XXXX-World-Map,panelIndex:2,row:1,size_x:12,size_y:4,type:visualization),
		//																(col:7,id:XXXX-Devices,panelIndex:3,row:5,size_x:6,size_y:3,type:visualization),
		//																(col:7,id:XXXX-Click-Thru-Rate-On-Our-Icon,panelIndex:4,row:10,size_x:6,size_y:2,type:visualization),
		//																(col:7,id:XXXX-Click-Thru-Rate-On-Items,panelIndex:5,row:8,size_x:6,size_y:2,type:visualization),
		//																(col:1,id:XXXX-Top-20-Trending-Images,panelIndex:6,row:10,size_x:6,size_y:3,type:visualization),
		//																(col:1,id:XXXX-Unique-Users,panelIndex:7,row:13,size_x:3,size_y:2,type:visualization),
		//																(col:7,id:XXXX-Top-20-Trending-Categories,panelIndex:8,row:12,size_x:6,size_y:3,type:visualization),
		//																(col:4,id:XXXX-Average-Time-on-Site,panelIndex:9,row:13,size_x:3,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:'Dashboard',uiState:(P-1:(spy:(mode:(fill:!f,name:!n))),P-2:(spy:(mode:(fill:!f,name:!n)))))&token=${user.token}";
    	...
    	String json = "{" +
			...
			"\"panelsJSON\":\"[" +
				...
				"{\\\"col\\\":1,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Events-Breakdown\\\",\\\"panelIndex\\\":1,\\\"row\\\":5,\\\"size_x\\\":6,\\\"size_y\\\":5,\\\"type\\\":\\\"visualization\\\"}," +
				...
				"{\\\"col\\\":7,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Click-Thru-Rate-On-Our-Icon\\\",\\\"panelIndex\\\":4,\\\"row\\\":10,\\\"size_x\\\":6,\\\"size_y\\\":2,\\\"type\\\":\\\"visualization\\\"}," +
				"{\\\"col\\\":7,\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Click-Thru-Rate-On-Items\\\",\\\"panelIndex\\\":5,\\\"row\\\":8,\\\"size_x\\\":6,\\\"size_y\\\":2,\\\"type\\\":\\\"visualization\\\"}," +
				"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Top-20-Trending-Images\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":6,\\\"size_x\\\":6,\\\"size_y\\\":3,\\\"col\\\":1,\\\"row\\\":10}," +
				
				"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Unique-Users\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":7,\\\"size_x\\\":3,\\\"size_y\\\":2,\\\"col\\\":1,\\\"row\\\":13}," +
				"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Top-20-Trending-Categories\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":8,\\\"size_x\\\":6,\\\"size_y\\\":3,\\\"col\\\":7,\\\"row\\\":12}," +

				"{\\\"id\\\":\\\""+ publisher.getEncodedName() +"-Average-Time-on-Site\\\",\\\"type\\\":\\\"visualization\\\",\\\"panelIndex\\\":9,\\\"size_x\\\":3,\\\"size_y\\\":2,\\\"col\\\":4,\\\"row\\\":13}" +
