...
<html>
	...
	<body>
		...
		<iframe id="kibanaDashboard" onload="manager.publisher.resizeIframe($(this))" style="border:none;" width="100%" src="/publisher-manager/private/app/kibana/${user.token}#/dashboard/${loggedInUser.encodedName}-Dashboard?embed=true&_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now%2Fw,mode:quick,to:now%2Fw))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:${loggedInUser.encodedName}-Events-Breakdown,panelIndex:1,row:5,size_x:6,size_y:5,type:visualization),(col:1,id:${loggedInUser.encodedName}-World-Map,panelIndex:2,row:1,size_x:12,size_y:4,type:visualization),(col:7,id:${loggedInUser.encodedName}-Devices,panelIndex:3,row:5,size_x:6,size_y:3,type:visualization),(col:7,id:${loggedInUser.encodedName}-Click-Thru-Rate-On-Our-Icon,panelIndex:4,row:10,size_x:6,size_y:2,type:visualization),(col:7,id:${loggedInUser.encodedName}-Click-Thru-Rate-On-Items,panelIndex:5,row:8,size_x:6,size_y:2,type:visualization),(col:1,id:${loggedInUser.encodedName}-Top-20-Trending-Images,panelIndex:6,row:10,size_x:6,size_y:3,type:visualization),(col:1,id:${loggedInUser.encodedName}-Unique-Users,panelIndex:7,row:13,size_x:3,size_y:2,type:visualization),(col:7,id:${loggedInUser.encodedName}-Top-20-Trending-Categories,panelIndex:8,row:12,size_x:6,size_y:3,type:visualization),(col:4,id:${loggedInUser.encodedName}-Average-Time-on-Site,panelIndex:9,row:13,size_x:3,size_y:2,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:'Dashboard',uiState:(P-1:(spy:(mode:(fill:!f,name:!n))),P-2:(spy:(mode:(fill:!f,name:!n)))))&token=${user.token}"></iframe>
